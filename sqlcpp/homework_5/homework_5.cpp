//homework_5 SQLCPP-5  Домашнее задание к занятию «Работа с PostgreSQL из C++»
	...
	try {
		...
		pqxx::work tx{ c };
			...
			case 1:
				...
				continue;
			case 2:
				dbm.addPhoneNumber(tx);
				continue;
			case 3:
				dbm.changeClientData(tx);
				continue;
			case 4:
				dbm.deleteClientPhone(tx);
				continue;
			case 5:
				dbm.deleteClient(tx);
				continue;
